...
import 'package:whiteboard_demo/models/line.dart';
import 'package:whiteboard_demo/models/point.dart';
        ...
        child: AspectRatio(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) => GestureDetector(
              onPanDown: (details) {
                onGestureStart.call(_getOffsetPoint(
